...
public class OutboundPort {
  ...
  public static void publishEvent(String address, Event message) {
  ...
  public static Subject<Event> eventRegister(String address) {
    return requests.computeIfAbsent(address, key -> PublishSubject.create());
  }

  public static Single<Event> requestEvent(String address) {
